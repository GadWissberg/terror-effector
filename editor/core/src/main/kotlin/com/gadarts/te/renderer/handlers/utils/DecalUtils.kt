...
object DecalUtils {
    ...
    fun applyFrameSeenFromCameraForCharacterDecal(
        ...
        val name: String =
            java.lang.String.format(TerrorEffectorEditor.FRAMES_KEY_CHARACTER, characterDefinition.id())
        val hashMap: EnumMap<Direction, TextureAtlas.AtlasRegion> =
            gameAssetsManager.get(name.lowercase(Locale.getDefault()))
