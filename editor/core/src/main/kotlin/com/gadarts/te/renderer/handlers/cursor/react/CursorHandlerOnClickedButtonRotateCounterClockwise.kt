...
class CursorHandlerOnClickedButtonRotateCounterClockwise(private val cursorHandler: CursorHandler) : HandlerOnEvent {
    override fun react(
        msg: Telegram,
        ...
        cursorHandler.objectModelCursor?.rotateCounterClockwise()
    }
